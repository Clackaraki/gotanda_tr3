...
// グローバルな game オブジェクト　後からわかりやすいように最初に定義する
const game = {
    counter: 0,
    backGrounds: [],
    enemys: [], //空の配列
...
for (const imageName of imageNames) {
    ...
    game.image[imageName] = new Image(); // imageオブジェクトをgameのimage[imagename]に代入する image: { "bird": {image} }
...
function drawBackGrounds(){
    ...
    ctx.fillRect(backGround.x, backGround.y - 5, backGround.width - 40, 5);
    ctx.gillRect(backGround.x+50, backGround.y - 15, background.width - 100, 5);
}
